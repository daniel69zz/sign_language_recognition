...
modelo = (r'C:\Users\HP\Downloads\programacion_etc\sign_language_recognition\Modelo.keras')
peso =  (r'C:\Users\HP\Downloads\programacion_etc\sign_language_recognition\pesos.weights.h5')
cnn = load_model(modelo)  #Cargamos el modelo
cnn.load_weights(peso)  #Cargamos los pesos

direccion = (r'C:\Users\HP\Downloads\programacion_etc\sign_language\datos_valid')
